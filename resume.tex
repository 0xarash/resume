...
\cvitem{Triangular Arbitrage}{This is a simple implementation of triangular arbitrage. The Bellman-Ford algorithm is used to detect tradable cycles with Go language.}
