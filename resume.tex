...
\cvlistitem{Worked with a team on the development of a DLP project, where I primarily contributed to the Windows user-mode service and kernel-mode driver development. Utilized C, modern C++11/14, Google Protobuf, and Boost.}
...
\cvlistitem{Engineered multi-task CTI (Computer Telephony Integration) software on Texas Instrument C6000 DSP series processor. Analog hardware telephones and DSP-toPC communication accomplished through PCI bus. Utilized Real-Time OS called DSP/BIOS from TI with customized in-house boot-loader.}
...
\cvlistitem{Managed design of new VoIP license architecture and GUI software to unify configuration of DLS2000 using C++ and Qt.}
